    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    <h1 class="mb-4" style="font-size: 4rem;">Community</h1>

                    <!-- Search Bar (Below Accounts Heading) -->
                    <div class="mb-4">
                        <form action="{{ route('admin.community.search') }}" method="GET" class="d-flex justify-content-end align-items-center">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                @if ($community->isEmpty())
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">No post has been found.</td>
                                    </tr>
                                @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-link text-danger p-0"
                                                    onclick="openDeleteModal('{{ route('admin.community.softDelete', ['community' => $community->com_id]) }}')">
