        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    ...
                    <div class="mb-4">
                        <form action="{{ route('admin.accounts.search') }}" method="GET" class="d-flex">
                            <input type="text" name="query" class="form-control me-2" placeholder="Search.." value="{{ request()->query('query') }}">
                            <button type="submit" class="btn btn-primary" style="background-color:#803737">Search</button>
                        </form>
                    </div>
                            ...
                            @else
                                @foreach ($user as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user->password }}</td>
                                        <td>{{ $user->status }}</td>
                                        <td><a href="{{ route('admin.accounts.edit', ['user' => $user->user_id]) }}"
