    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    <h1 class="mb-4" style="font-size: 4rem;">Recipes</h1>

                    <!-- Search Bar (Below Accounts Heading) -->
                    <div class="mb-4">
                        <form action="{{ route('admin.recipes.search') }}" method="GET" class="d-flex justify-content-end align-items-center">
                            <input type="text" style="border: 2px solid; border-radius: 20px; width: 20%;" name="query" class="form-control me-2" placeholder="Search.."
                                value="{{ request()->query('query') }}">
                            <button type="submit" class="btn btn-primary"
                                style="background-color:#803737; border-radius: 20px;" >Search</button>
                        </form>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center">No recipe has been found.</td>
                                </tr>
                            @else
                                    @foreach ($recipe as $recipe)
                                        <tr>
                                            ...
                                            <td>{{ $recipe->m_ingred }}</td>
                                            <td>{{ $recipe->ingredients }}</td>
                                            <td>{{ $recipe->steps }}</td>
                                            <td>{{ $recipe->img }}</td>
                                            <td>{{ $recipe->cost }}</td>
                                            <td>{{ $recipe->holiday }}</td>
                                            <td>{{ $recipe->created_at }}</td>
                                            <td>
                                                <button type="button" class="btn btn-link text-danger p-0"
                                                    onclick="openDeleteModal('{{ route('admin.recipes.softDelete', ['recipes' => $recipe->recipe_id]) }}')">
