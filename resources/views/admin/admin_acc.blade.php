    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    <h1 class="mb-4" style="font-size: 4rem;">Accounts</h1>

                    <!-- Search Bar (Below Accounts Heading) -->
                    <div class="mb-4">
                        <form action="{{ route('admin.accounts.search') }}" method="GET" class="d-flex justify-content-end align-items-center">
                            <input type="text" style="border: 2px solid; border-radius: 20px; width: 20%;" name="query" class="form-control me-2" placeholder="Search.." value="{{ request()->query('query') }}">
                            <button type="submit" class="btn btn-primary" style="background-color:#803737; border-radius: 20px;">Search</button>
                        </form>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    <td colspan="9" class="text-center">No user has been found.</td>
                                </tr>
                            @else
                                @foreach ($user as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user->password }}</td>
                                        <td>{{ $user->status }}</td>
                                        <td><a href="{{ route('admin.accounts.edit', ['user' => $user->user_id]) }}" class="text-primary">
                                            <img src="{{ asset('admin_account_images/edit-icon (2).png') }}" alt="Edit" width="20" height="20">
                                        </a>
                                            <br>
                                            <form action="{{ route('admin.accounts.softDelete', ['user' => $user->user_id]) }}"
