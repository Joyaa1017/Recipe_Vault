...
<head>
    ...
    <style>
        ...
        /* Change bookmark icon to filled when active */
        .bookmark-highlight .bookmark-icon {
...
<body>
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="container mt-5">
                    ...
                    <div class="recipe-card p-4 rounded" style="background-color: #f8f9fa; position: relative;">
                            ...
                            <div class="ml-3 flex-grow-1">
                                <h2 class="mb-3">
                                    ...
                                    <button type="button" class="btn btn-primary bookmark-button"
                                        style="background-color:#3E3737; border-color:#3E3737" data-bs-toggle="modal"
                                ...
                                <h6 class="mb-3">
                                    Chef: <a
                                        href="{{ route('users.view_other_profile', ['user_id' => $userother->user_id]) }}"
                        ...
                        <a href="{{ route('users.profile.show') }}" class="btn btn-primary btn-sm"
                            ...
                            <div class="modal-body">
                                <form action="{{ route('users.recipes.addRecipe_in_collection') }}" method="POST">
                                    ...
                                    <button type="button" class="btn btn-secondary me-2" data-bs-toggle="modal"
                                        ...
                                        style="background-color:#8a3c3c; border-color:#8a3c3c; margin-top:15px">
                                        Create Collection

                                    </button>
                                    <button type="submit" class="btn btn-success mt-3"
                                        style="background-color:#8a3c3c; border-color:#8a3c3c">Add to
                                        Collection</button>
    ...
    <script>
        // Toggle the bookmark highlight and icon
        function toggleBookmark(button) {
            button.classList.toggle('bookmark-highlight');
            const icon = button.querySelector('.bookmark-icon');
            if (icon.classList.contains('fa-regular')) {
                icon.classList.replace('fa-regular', 'fa-solid'); // Change to filled bookmark
            } else {
                icon.classList.replace('fa-solid', 'fa-regular'); // Change to outlined bookmark
            }
        }
    </script>
