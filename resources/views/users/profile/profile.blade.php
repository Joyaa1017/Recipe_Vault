        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                    ...
                    <div class="ms-3">
                        <h2 class="h4 mb-0">{{ session('user.username', 'Guest User') }}</h2>
                        <p class="mb-0 text-muted">{{ session('user.fullname', 'Full Name Not Available') }}</p>
                ...
                <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a href="{{ route('users.profile.addrecipe') }}" class="btn btn-primary">Add Recipe</a>
                </div>
                ...
                <div class="row">
                    @if ($recipes->isEmpty())
                        <div class="col-12">
                            <p>No recipe has been made yet.</p>
                        </div>
                    @else
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-3">
                                                <div>
                                                    ...
                                                    <a href="{{ route('users.profile.recipes_edit', $recipe->recipe_id) }}"
                                                ...
                                                <!-- Delete Button -->
                                                <form
                                                    action="{{ route('users.profile.recipes_destroy', $recipe->recipe_id) }}"
                                                    method="POST" style="margin: 0;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger"
                                                        style=" background-color: #3E3737; border-color:#3E3737"
                                                        onclick="return confirm('Are you sure you want to delete this recipe?')">
                                                        <img src="{{ asset('profile_images/delete.png') }}"
                                                            alt="Edit Icon" style="width: 50px; height: 50px;">
            ...
            @foreach ($recipes as $recipe)
                <div class="modal fade" id="createCollectionModal{{ $recipe->recipe_id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="createCollectionModalLabel{{ $recipe->recipe_id }}">
                                    Create New Collection</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form action="{{ route('users.profile.collection_create_store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="collectionName"
                                            name="collect_name" required placeholder="Enter collection name">
                                    </div>
                                    <div class="mb-3">
                                        <label for="collectionDescription" class="form-label">Description
                                            (Optional)</label>
            ...
            <div class="modal fade" id="profilePictureModal" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('users.profile.updateProfilePicture') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="profilePictureInput" class="form-label">Choose a new profile
                                        picture</label>
